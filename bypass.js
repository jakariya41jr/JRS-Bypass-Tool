...
// ║  CREATE: Soyon Ahmed (soyon41)                       ║
// ║  JRS DYNAMIC (USERDATA UPGRADE)                      ║
// ╚══════════════════════════════════════════════════════════╝
...
(function () {
  ...
  // ═══════════════════ APP INFO ═══════════════════
  // Dev: Md Jakariya Hasan - https://jakariya41jr.xyz/
  // Create: Soyon Ahmed (soyon41)
  const APP_NAME = "JRS";
  ...
  // Password check — only "jrs41"
  function needPassword() { return true; }   // Always require password
  ...
  function renderInitPanel() {
    ...
    const { wrapper, focusGlow1, focusGlow2 } = createWrapper(`
      ...
      <div class="nb-footer"><a href="https://jakariya41jr.xyz/" target="_blank">Dev: Md Jakariya Hasan</a> | Create: Soyon Ahmed (soyon41) | ${APP_FULL_NAME} | 📳 Shake to change track 🎵</div>
    `, "overflow-visible");
  ...
  (async function () {
    ...
    // No user data fetch, no ban checks — only password gate
